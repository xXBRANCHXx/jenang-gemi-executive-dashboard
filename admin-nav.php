...
function admin_quick_menu_definitions(): array
{
    return [
        ...
        'inventory-recap' => [
            ...
            'description' => 'Visual stock coverage by days left',
            'alert_key' => 'inventory-recap',
        ],
        'purchase-order' => [
            'href' => '../dashboard/?view=purchase-order',
            'view' => 'purchase-order',
            'icon' => 'purchase-order',
            'label' => 'Purchase Plan',
            'description' => 'Edit recommended stock and download PDF',
        ],
        'campaigns' => [
        ...
        'ad-view' => [
            ...
            'icon' => 'rocket',
            'label' => 'Ad View',
            'description' => 'Shopee Ads comparison and actions',
        ],
        'back-dash' => [
            'href' => '../back-dash/',
            'icon' => 'back-dash',
...
function admin_quick_menu_context_map(): array
{
    return [
        ...
        'inventory-recap' => ['purchase-order', 'home', 'orders', 'sku-db', 'settings'],
        'purchase-order' => ['inventory-recap', 'home', 'sku-db', 'settings'],
        'campaigns' => ['home', 'orders', 'ad-view', 'affiliates', 'back-dash', 'context', 'settings'],
        'ad-view' => ['home', 'campaigns', 'orders', 'back-dash', 'settings'],
        'back-dash' => ['home', 'context', 'hard-set', 'settings'],
        'context' => ['home', 'back-dash', 'settings'],
...
function render_admin_sidebar(string $activeSection = ''): void
{
    ...
    $items = [
        ...
        [
            ...
            'aria' => 'Open Shopee advertising comparison dashboard',
            'view' => 'ad-view',
        ],
        [
            'key' => 'website',
...
function admin_topbar_menu_icon(string $icon): string
{
    $icons = [
        ...
        'whatsapp' => '<span class="admin-whatsapp-icon" aria-hidden="true"></span>',
        ...
        'purchase-order' => '<svg viewBox="0 0 24 24"><rect width="16" height="18" x="4" y="3" rx="2"/><path d="M9 3v3h6V3"/><path d="M8 11h8M8 15h5"/></svg>',
...
{
    echo '<aside class="admin-notification-drawer admin-partner-billing-drawer" data-billing-notification-drawer role="dialog" aria-label="Notifications" aria-hidden="true">';
    echo '<div class="admin-notification-head">';
    echo '<div class="admin-notification-head-main">';
    echo '<button type="button" class="admin-notification-round-btn admin-notification-back" data-billing-notification-back aria-label="Back to notifications" hidden>';
    ...
    echo '</span>';
    echo '<div><h2>Notifications</h2><p class="admin-notification-mode" data-billing-notification-mode>Partner activity requiring attention</p></div>';
    echo '</div>';
    ...
    echo '</div>';
    echo '<div class="admin-notification-list admin-partner-billing-list" data-billing-notification-list aria-live="polite"><p class="admin-empty">Loading notifications...</p></div>';
    echo '</aside>';
