            ...
            <main class="profit-loss-layout admin-accounting-view" data-accounting-view>
                <section class="admin-accounting-hero">
                    <div>
                        ...
                        <h2>Accounting</h2>
                        <p>Cash, bills, expenses, and manual finance control</p>
                        <span class="admin-panel-meta" data-accounting-status>Accounting updated just now</span>
                    </div>
                ...
                <section class="admin-accounting-toolbar admin-accounting-panel" aria-label="Accounting command bar">
                    <label>
                        <span>Month</span>
                        <input type="month" data-accounting-month-select>
                    </label>
                    <div class="admin-panel-inline-toggles" data-accounting-range-controls aria-label="Accounting range">
                ...
                <section class="admin-accounting-kpi-grid" aria-label="Accounting KPI cards">
                    ...
                    <article class="admin-accounting-kpi"><span>Pending Review</span><strong data-accounting-kpi="pending-review">0</strong><small>Needs cleanup</small></article>
                </section>

                <section class="admin-accounting-panel">
                    <div class="admin-panel-head">
                        <div><span class="admin-panel-kicker">Accounting Command Bar</span><h3>What needs attention</h3></div>
                    </div>
                ...
                <section class="admin-accounting-panel admin-accounting-quick-entry">
                    ...
                    <div class="admin-accounting-mode-row">
                        ...
                        <button type="button" class="admin-toggle-pill" data-accounting-quick-mode="manual_income">Manual Money In</button>
                    </div>
                    ...
                    <form class="admin-accounting-form" data-accounting-form>
                        ...
                        <div class="admin-accounting-warning" data-accounting-marketplace-warning hidden>Marketplace sales are already counted from Orders/Wallet. Use Transfer Money for payouts, not Manual Money In.</div>
                ...
                <section class="admin-main-grid admin-accounting-main-grid">
                    ...
                    <article class="admin-panel admin-accounting-panel">
                        <div class="admin-panel-head">
                            <div><span class="admin-panel-kicker">Profit &amp; Cash Summary</span><h3>Profit context and cash movement</h3></div>
                        </div>
                    ...
                    <article class="admin-panel admin-accounting-panel">
                        <div class="admin-panel-head">
                            <div><span class="admin-panel-kicker">Category / Vendor Insights</span><h3>Spend split</h3></div>
                        </div>
                    ...
                    <article class="admin-panel admin-accounting-panel admin-panel-wide">
                        <div class="admin-panel-head">
                            <div><span class="admin-panel-kicker">Review Queue</span><h3>Data quality checks</h3></div>
