...
$pageTitle = $skuDbMode === 'new'
    ? 'Add SKU | Jenang Gemi Executive Dashboard'
    : 'SKU Database | Jenang Gemi Executive Dashboard';
$pageChip = $skuDbMode === 'new' ? 'New SKU Setup' : 'SKU Database';
$pageHeading = $skuDbMode === 'new' ? 'Create and apply a new SKU' : 'Shopee Partner SKU Database';
$pageDescription = $skuDbMode === 'new'
    ...
    : 'Start filling the SKU database now so brands, flavors, products, TAGs, COGS, and quantity records are ready before the production database is connected.';
?>
<!DOCTYPE html>
<html lang="id">
<head>
            ...
            <div class="admin-topbar-actions">
                ...
                <div class="admin-menu-shell" data-menu-shell>
                    ...
                    <div class="admin-menu-panel" data-menu-panel hidden>
                        ...
                        <a class="admin-menu-item admin-link-btn" href="<?php echo htmlspecialchars($relativeRoot, ENT_QUOTES); ?>dashboard/" data-dashboard-view-link="website">Official Website Dashboard</a>
                        <a class="admin-menu-item admin-link-btn" href="<?php echo htmlspecialchars($relativeRoot, ENT_QUOTES); ?>affiliate-program/">Affiliate Program Dashboard</a>
