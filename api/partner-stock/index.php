...
try{$pdo=jg_partner_stock_db();
    ...
    jg_partner_stock_json(['ok'=>false,'error'=>'Unknown Class B action.'],400);
}catch(InvalidArgumentException $e){jg_partner_stock_json(['ok'=>false,'error'=>$e->getMessage()],422);}catch(RuntimeException $e){jg_partner_stock_json(['ok'=>false,'error'=>$e->getMessage()],409);}catch(Throwable $e){error_log('Partner stock API failed: '.$e->getMessage());jg_partner_stock_json(['ok'=>false,'error'=>'Class B operations are temporarily unavailable.'],500);}
