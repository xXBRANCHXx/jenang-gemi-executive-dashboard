    ...
    tableBody.innerHTML = rows.map((row) => {
      ...
      <tr class="admin-sku-row ${stockState}">
        ...
        <td data-col="Shipping">
          <button type="button" class="admin-ghost-btn admin-sku-shipping-settings-btn${row.shipping_profile_complete ? ' is-complete' : ''}" data-change-shipping="${escapeHtml(row.sku || '')}" aria-label="Open shipment settings for SKU ${escapeHtml(row.sku || '')}">
            <span>Settings</span>
          </button>
