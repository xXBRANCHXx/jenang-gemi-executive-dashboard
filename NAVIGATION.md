...
This change reorganizes the shared navigation around existing page content.
...
The UI uses neutral light/dark surfaces and restrained teal navigation accents.
...
`exec3.98.12`. No migrations or new environment settings are required.
