...
blog_expect(true, str_contains($youtubeHtml, 'data-youtube-width="18"') && str_contains($youtubeHtml, '--youtube-width:18%'), 'YouTube preview widths should persist down to the compact minimum.');
blog_expect(true, str_contains($youtubeHtml, 'data-youtube-align="right"'), 'YouTube preview placement should persist through sanitization.');
