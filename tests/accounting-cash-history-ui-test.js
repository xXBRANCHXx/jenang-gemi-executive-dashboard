...
expect(html.includes('value="jenang-gemi">Jenang Gemi</option>'), 'Cash history must offer the Jenang Gemi account.');
expect(html.includes('value="zero">ZERO</option>'), 'Cash history must offer the ZERO account.');
expect(html.includes('value="zfit">ZFIT</option>'), 'Cash history must offer the ZFIT account.');
...
expect(script.includes("'Net filtered cash'"), 'Cash history must label a filtered net without presenting it as the full bank balance.');
