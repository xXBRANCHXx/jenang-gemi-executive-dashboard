...
$pdo->exec('CREATE TABLE accounting_transactions (
    ...
    reference_no TEXT, order_no TEXT, invoice_no TEXT, notes TEXT, channel TEXT
)');
...
$pdo->exec("INSERT INTO accounting_transactions VALUES
    (1, 'TX-IN', 'posted', 'manual_income', 'money_in', 1, NULL, 1, 1, '2026-07', '2026-07-01', 40000, 0, 'SALE-1', '', '', 'Cash sale', 'Shopee'),
    (2, 'TX-OUT', 'posted', 'expense', 'money_out', 1, NULL, 2, 2, '2026-07', '2026-07-02', 10000, 0, '', '', '', 'Paper and ink', 'Offline'),
    (3, 'TX-MOVE', 'posted', 'transfer', 'internal_transfer', 1, 2, NULL, NULL, '2026-07', '2026-07-03', 20000, 1000, '', '', '', '', 'Internal'),
    (4, 'TX-WALLET', 'posted', 'transfer', 'internal_transfer', 3, 1, NULL, NULL, '2026-07', '2026-07-04', 30000, 0, '', '', '', '', 'Shopee'),
    (5, 'TX-PAYABLE', 'posted', 'transfer', 'internal_transfer', 2, 4, NULL, NULL, '2026-07', '2026-07-05', 5000, 0, '', '', '', 'Cash moved out', 'Internal'),
    (6, 'TX-VOID', 'void', 'expense', 'money_out', 1, NULL, NULL, NULL, '2026-07', '2026-07-06', 999999, 0, '', '', '', 'Must not appear', 'Offline')");
